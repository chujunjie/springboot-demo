package com.example.springbootdemo.JVMTest.systemOutputRedirection;
...
//        System.out.println("第三行");
    ...
    public static void exec() throws IOException {
        ...
        classBytes = classModifier.modifyUTF8Constant("java/lang/System", "com/example/springbootdemo/JVMTest/HackSystem");
        //输出查看
